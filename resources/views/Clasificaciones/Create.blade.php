                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5 booking">
                                    ...
                                    <div class="card-body ">
                                            ...
                                            <div class="booking-form">
                                                    ...
                                                    <form action="/Clasificaciones/Save" method="post" id="form">
                                                        @csrf
                                                        <div class="control-group">
                                                            <div class="input-group">
                                                                
                                                                 <label for="Nombre_Clasificacion" class="col col-form-label text-left">{{ __('Enter Name Clasification') }}</label>
                                                                <input type="text" id="Nombre_Clasificacion" class="form-control" name="Nombre_Clasificacion"   value="" placeholder="Name"  autocomplete="off" required="required"  required/>
